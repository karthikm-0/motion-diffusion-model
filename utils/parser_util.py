...
def add_model_options(parser):
    ...
    group.add_argument("--text_encoder_type", default='clip',
                       choices=['clip', 'bert', 'precomputed'], type=str, help="Text encoder type.")
...
def add_data_options(parser):
    ...
    group.add_argument("--dataset", default='humanml', choices=['humanml', 'kit', 'humanact12', 'uestc', 'crisp'], type=str,
...
def get_cond_mode(args):
    if args.unconstrained:
        cond_mode = 'no_cond'
    elif args.dataset in ['kit', 'humanml', 'crisp']:
        cond_mode = 'text'
    else:
        cond_mode = 'action'
    return cond_mode
